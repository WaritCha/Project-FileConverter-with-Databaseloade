...
def process_files(ds_names=None):
    ...
    pprocesses = len(ds_names) if len(ds_names) < 6 else 6
...
os.environ['SRC_BASE_DIR']='/Users/warit/Projects/python-revision-for-de/data/retail_db'
os.environ['DB_HOST']='localhost'
os.environ['DB_PORT']='5432'
os.environ['DB_NAME']='bas_retail_db'
os.environ['DB_USER']='bas_retail_user'
os.environ['DB_PASS']='412563'
